 ...
 */
#define CONFIGURATION_H_VERSION 161222
...
#define STRING_CONFIG_H_AUTHOR "(Me3D)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Me2-161222"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "402212C5-6F7C-4AF0-A828-BBE145876125"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  //Me2
    #define  DEFAULT_Kp 8.13
    #define  DEFAULT_Ki 0.25
    #define  DEFAULT_Kd 66.32 
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 25, 75 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { 15, 15, (Z_MIN_POS + 1)}
